...
//             <a href='https://facebook.com/TechHelpBD' target='_blank' title='Facebook' rel='noopener noreferrer'>
            ...
            <div className="flex flex-col sm:flex-row justify-around">
              ...
              >
                ...
                <p className='max-w-[26rem]'>
                  ...
                  We are excited to provide you with a user-friendly online platform to compile your code. Our compiler supports various programming languages including C, C++, Java, Python and more. <br /> <br />
              ...
              >
                ...
                <ul>
                  ...
                  <li className="mb-2 leading-6">
                    <Link className="transition-colors duration-300 hover:text-gray-100 focus:text-gray-50" to="/saved-codes">Saved Codes</Link>
                  </li>
                </ul>
              </nav>
              <nav
